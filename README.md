...
- The `AnySuccess` concurrent execution strategy only returns a **exceptional** result when **all** inputs is exceptional
...
In addition to the commonly used `AllFailFast` and `AnySuccess` concurrency strategies mentioned above,

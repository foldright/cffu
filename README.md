...
> 🚧 项目还在开发中，发布了`v0.x`版本： [![Maven Central](https://img.shields.io/maven-central/v/io.foldright/cffu?logo=apache-maven&logoColor=white)](https://central.sonatype.com/artifact/io.foldright/cffu/0.2.0/versions)
>
...
<a href="https://central.sonatype.com/artifact/io.foldright/cffu/0.2.0/versions"><img src="https://img.shields.io/maven-central/v/io.foldright/cffu?logo=apache-maven&logoColor=white" alt="Maven Central"></a>
...
```groovy
// Gradle Kotlin DSL
implementation("io.foldright:cffu:0.2.0")

// Gradle Groovy DSL
implementation 'io.foldright:cffu:0.2.0'
```

可以在 [central.sonatype.com](https://central.sonatype.com/artifact/io.foldright/cffu/0.2.0/versions) 查看最新版本与可用版本列表。

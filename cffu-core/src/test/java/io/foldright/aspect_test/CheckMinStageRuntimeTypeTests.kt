...
class CheckMinStageRuntimeTypeTests : AnnotationSpec() {
    ...
    fun test_CompletableFutureUtils_methods() {
        ...
        CompletableFutureUtils.mSupplyTupleFailFastAsync(Supplier { n }, { s }, { d }).shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyTupleFailFastAsync(testExecutor, { n }, { s }, { d }).shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyTupleFailFastAsync(Supplier { n }, { s }, { d }, { n }).shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyTupleFailFastAsync(testExecutor, { n }, { s }, { d }, { n })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyTupleFailFastAsync(Supplier { n }, { s }, { d }, { n }, { s })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyTupleFailFastAsync(testExecutor, { n }, { s }, { d }, { n }, { s })
            .shouldNotBeMinimalStage()

        CompletableFutureUtils.mSupplyAllSuccessTupleAsync({ n }, { s }).shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyAllSuccessTupleAsync(testExecutor, { n }, { s }).shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyAllSuccessTupleAsync(Supplier { n }, { s }, { d }).shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyAllSuccessTupleAsync(testExecutor, { n }, { s }, { d }).shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyAllSuccessTupleAsync(Supplier { n }, { s }, { d }, { n })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyAllSuccessTupleAsync(testExecutor, { n }, { s }, { d }, { n })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyAllSuccessTupleAsync(Supplier { n }, { s }, { d }, { n }, { s })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyAllSuccessTupleAsync(testExecutor, { n }, { s }, { d }, { n }, { s })
            .shouldNotBeMinimalStage()

        CompletableFutureUtils.mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }).shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyMostSuccessTupleAsync(testExecutor, 1, MILLISECONDS, { n }, { s })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyMostSuccessTupleAsync(testExecutor, 1, MILLISECONDS, { n }, { s }, { d })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d }, { n })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyMostSuccessTupleAsync(testExecutor, 1, MILLISECONDS, { n }, { s }, { d }, { n })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d }, { n }, { s })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyMostSuccessTupleAsync(
            testExecutor, 1, MILLISECONDS, { n }, { s }, { d }, { n }, { s }).shouldNotBeMinimalStage()

        CompletableFutureUtils.mSupplyTupleAsync({ n }, { s }).shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyTupleAsync(testExecutor, { n }, { s }).shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyTupleAsync(Supplier { n }, { s }, { d }).shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyTupleAsync(testExecutor, { n }, { s }, { d }).shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyTupleAsync(Supplier { n }, { s }, { d }, { n }).shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyTupleAsync(testExecutor, { n }, { s }, { d }, { n }).shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyTupleAsync(Supplier { n }, { s }, { d }, { n }, { s }).shouldNotBeMinimalStage()
        CompletableFutureUtils.mSupplyTupleAsync(testExecutor, { n }, { s }, { d }, { n }, { s })
            .shouldNotBeMinimalStage()
        ...
        CompletableFutureUtils.thenMApplyAllSuccessTupleAsync(cfThis, testExecutor, { n }, { s })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.thenMApplyAllSuccessTupleAsync(cfThis, Function { n }, { s }, { d })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.thenMApplyAllSuccessTupleAsync(cfThis, testExecutor, { n }, { s }, { d })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.thenMApplyAllSuccessTupleAsync(cfThis, Function { n }, { s }, { d }, { n })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.thenMApplyAllSuccessTupleAsync(cfThis, testExecutor, { n }, { s }, { d }, { n })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.thenMApplyAllSuccessTupleAsync(cfThis, Function { n }, { s }, { d }, { n }, { s })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.thenMApplyAllSuccessTupleAsync(cfThis, testExecutor, { n }, { s }, { d }, { n }, { s })
            .shouldNotBeMinimalStage()

        CompletableFutureUtils.thenMApplyMostSuccessTupleAsync(cfThis, 1, MILLISECONDS, { n }, { s })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.thenMApplyMostSuccessTupleAsync(cfThis, testExecutor, 1, MILLISECONDS, { n }, { s })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.thenMApplyMostSuccessTupleAsync(cfThis, 1, MILLISECONDS, { n }, { s }, { d })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.thenMApplyMostSuccessTupleAsync(
            cfThis, testExecutor, 1, MILLISECONDS, { n }, { s }, { d }).shouldNotBeMinimalStage()
        CompletableFutureUtils.thenMApplyMostSuccessTupleAsync(cfThis, 1, MILLISECONDS, { n }, { s }, { d }, { n })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.thenMApplyMostSuccessTupleAsync(
        ...
        CompletableFutureUtils.thenMApplyTupleAsync(cfThis, { n }, { s }).shouldNotBeMinimalStage()
        CompletableFutureUtils.thenMApplyTupleAsync(cfThis, testExecutor, { n }, { s }).shouldNotBeMinimalStage()
        CompletableFutureUtils.thenMApplyTupleAsync(cfThis, Function { n }, { s }, { d }).shouldNotBeMinimalStage()
        CompletableFutureUtils.thenMApplyTupleAsync(cfThis, testExecutor, { n }, { s }, { d }).shouldNotBeMinimalStage()
        CompletableFutureUtils.thenMApplyTupleAsync(cfThis, Function { n }, { s }, { d }, { n })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.thenMApplyTupleAsync(cfThis, testExecutor, { n }, { s }, { d }, { n })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.thenMApplyTupleAsync(cfThis, Function { n }, { s }, { d }, { n }, { s })
            .shouldNotBeMinimalStage()
        CompletableFutureUtils.thenMApplyTupleAsync(cfThis, testExecutor, { n }, { s }, { d }, { n }, { s })
            .shouldNotBeMinimalStage()

...
class CheckMinStageRuntimeTypeTests : AnnotationSpec() {
    ...
    fun test_CffuFactory_methods() {
        ...
        testCffuFac.tupleOps().mSupplyTupleFailFastAsync(testFjExecutor, { n }, { s }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleFailFastAsync(Supplier { n }, { s }, { d }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleFailFastAsync(testFjExecutor, { n }, { s }, { d }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleFailFastAsync(Supplier { n }, { s }, { d }, { n }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleFailFastAsync(testFjExecutor, { n }, { s }, { d }, { n }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleFailFastAsync(Supplier { n }, { s }, { d }, { n }, { s }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleFailFastAsync(testFjExecutor, { n }, { s }, { d }, { n }, { s })
            .shouldNotBeMinimalStage()

        testCffuFac.tupleOps().mSupplyAllSuccessTupleAsync({ n }, { s }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyAllSuccessTupleAsync(testFjExecutor, { n }, { s }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyAllSuccessTupleAsync(Supplier { n }, { s }, { d }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyAllSuccessTupleAsync(testFjExecutor, { n }, { s }, { d }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyAllSuccessTupleAsync(Supplier { n }, { s }, { d }, { n }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyAllSuccessTupleAsync(testFjExecutor, { n }, { s }, { d }, { n }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyAllSuccessTupleAsync(Supplier { n }, { s }, { d }, { n }, { s }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyAllSuccessTupleAsync(testFjExecutor, { n }, { s }, { d }, { n }, { s })
            .shouldNotBeMinimalStage()

        testCffuFac.tupleOps().mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyMostSuccessTupleAsync(testFjExecutor, 1, MILLISECONDS, { n }, { s })
            .shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d })
            .shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyMostSuccessTupleAsync(testFjExecutor, 1, MILLISECONDS, { n }, { s }, { d })
            .shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d }, { n })
            .shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyMostSuccessTupleAsync(testFjExecutor, 1, MILLISECONDS, { n }, { s }, { d }, { n })
            .shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d }, { n }, { s })
            .shouldNotBeMinimalStage()
        ...
        testCffuFac.tupleOps().mSupplyTupleAsync(testFjExecutor, { n }, { s }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleAsync(Supplier { n }, { s }, { d }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleAsync(testFjExecutor, { n }, { s }, { d }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleAsync(Supplier { n }, { s }, { d }, { n }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleAsync(testFjExecutor, { n }, { s }, { d }, { n }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleAsync(Supplier { n }, { s }, { d }, { n }, { s }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleAsync(testFjExecutor, { n }, { s }, { d }, { n }, { s })
            .shouldNotBeMinimalStage()
    ...
    fun test_Cffu_methods() {
        ...
        cffuThis.tupleOps().thenMApplyTupleFailFastAsync(testFjExecutor, { n }, { s }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleFailFastAsync(Function { n }, { s }, { d }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleFailFastAsync(testFjExecutor, { n }, { s }, { d }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleFailFastAsync(Function { n }, { s }, { d }, { n }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleFailFastAsync(testFjExecutor, { n }, { s }, { d }, { n }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleFailFastAsync(Function { n }, { s }, { d }, { n }, { s }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleFailFastAsync(testFjExecutor, { n }, { s }, { d }, { n }, { s })
            .shouldNotBeMinimalStage()

        cffuThis.tupleOps().thenMApplyAllSuccessTupleAsync({ n }, { s }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyAllSuccessTupleAsync(testFjExecutor, { n }, { s }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyAllSuccessTupleAsync(Function { n }, { s }, { d }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyAllSuccessTupleAsync(testFjExecutor, { n }, { s }, { d }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyAllSuccessTupleAsync(Function { n }, { s }, { d }, { n }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyAllSuccessTupleAsync(testFjExecutor, { n }, { s }, { d }, { n }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyAllSuccessTupleAsync(Function { n }, { s }, { d }, { n }, { s }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyAllSuccessTupleAsync(testFjExecutor, { n }, { s }, { d }, { n }, { s })
            .shouldNotBeMinimalStage()

        cffuThis.tupleOps().thenMApplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyMostSuccessTupleAsync(testFjExecutor, 1, MILLISECONDS, { n }, { s })
            .shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyMostSuccessTupleAsync(testFjExecutor, 1, MILLISECONDS, { n }, { s }, { d })
            .shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d }, { n }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyMostSuccessTupleAsync(testFjExecutor, 1, MILLISECONDS, { n }, { s }, { d }, { n })
            .shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d }, { n }, { s })
            .shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyMostSuccessTupleAsync(testFjExecutor, 1, MILLISECONDS, { n }, { s }, { d }, { n }, { s })
            .shouldNotBeMinimalStage()

        cffuThis.tupleOps().thenMApplyTupleAsync({ n }, { s }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleAsync(testFjExecutor, { n }, { s }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleAsync(Function { n }, { s }, { d }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleAsync(testFjExecutor, { n }, { s }, { d }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleAsync(Function { n }, { s }, { d }, { n }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleAsync(testFjExecutor, { n }, { s }, { d }, { n }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleAsync(Function { n }, { s }, { d }, { n }, { s }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleAsync(testFjExecutor, { n }, { s }, { d }, { n }, { s }).shouldNotBeMinimalStage()

...
class CheckMinStageRuntimeTypeTests : AnnotationSpec() {
    ...
    fun test_CompletableFutureUtils_methods() {
        ...
        CfTupleUtils.mSupplyTupleFailFastAsync({ n }, { s }, testExecutor).shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyTupleFailFastAsync({ n }, { s }, Supplier { d }).shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyTupleFailFastAsync({ n }, { s }, { d }, testExecutor).shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyTupleFailFastAsync({ n }, { s }, { d }, Supplier { n }).shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyTupleFailFastAsync({ n }, { s }, { d }, { n }, testExecutor).shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyTupleFailFastAsync({ n }, { s }, { d }, { n }, Supplier { s }).shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyTupleFailFastAsync({ n }, { s }, { d }, { n }, { s }, testExecutor)
            .shouldNotBeMinimalStage()

        CfTupleUtils.mSupplyAllSuccessTupleAsync({ n }, { s }).shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyAllSuccessTupleAsync({ n }, { s }, testExecutor).shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyAllSuccessTupleAsync({ n }, { s }, Supplier { d }).shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyAllSuccessTupleAsync({ n }, { s }, { d }, testExecutor).shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyAllSuccessTupleAsync({ n }, { s }, { d }, Supplier { n }).shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyAllSuccessTupleAsync({ n }, { s }, { d }, { n }, testExecutor).shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyAllSuccessTupleAsync({ n }, { s }, { d }, { n }, Supplier { s })
            .shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyAllSuccessTupleAsync({ n }, { s }, { d }, { n }, { s }, testExecutor)
            .shouldNotBeMinimalStage()

        CfTupleUtils.mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }).shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, testExecutor)
            .shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, Supplier { d })
            .shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d }, testExecutor)
            .shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d }, Supplier { n })
            .shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d }, { n }, testExecutor)
            .shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d }, { n }, Supplier { s })
            .shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyMostSuccessTupleAsync(
            1, MILLISECONDS, { n }, { s }, { d }, { n }, { s }, testExecutor
        ).shouldNotBeMinimalStage()

        CfTupleUtils.mSupplyTupleAsync({ n }, { s }).shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyTupleAsync({ n }, { s }, testExecutor).shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyTupleAsync({ n }, { s }, Supplier { d }).shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyTupleAsync({ n }, { s }, { d }, testExecutor).shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyTupleAsync({ n }, { s }, { d }, Supplier { n }).shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyTupleAsync({ n }, { s }, { d }, { n }, testExecutor).shouldNotBeMinimalStage()
        CfTupleUtils.mSupplyTupleAsync({ n }, { s }, { d }, { n }, Supplier { s }).shouldNotBeMinimalStage()
        ...
        CfTupleUtils.thenMApplyTupleFailFastAsync(cfThis, { n }, { s }, testExecutor).shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyTupleFailFastAsync(cfThis, { n }, { s }, Function { d }).shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyTupleFailFastAsync(cfThis, { n }, { s }, { d }, testExecutor).shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyTupleFailFastAsync(cfThis, { n }, { s }, { d }, Function { n }).shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyTupleFailFastAsync(cfThis, { n }, { s }, { d }, { n }, testExecutor)
            .shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyTupleFailFastAsync(cfThis, { n }, { s }, { d }, { n }, Function { s })
            .shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyTupleFailFastAsync(cfThis, { n }, { s }, { d }, { n }, { s }, testExecutor)
            .shouldNotBeMinimalStage()

        CfTupleUtils.thenMApplyAllSuccessTupleAsync(cfThis, { n }, { s }).shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyAllSuccessTupleAsync(cfThis, { n }, { s }, testExecutor).shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyAllSuccessTupleAsync(cfThis, { n }, { s }, Function { d }).shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyAllSuccessTupleAsync(cfThis, { n }, { s }, { d }, testExecutor).shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyAllSuccessTupleAsync(cfThis, { n }, { s }, { d }, Function { n })
            .shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyAllSuccessTupleAsync(cfThis, { n }, { s }, { d }, { n }, testExecutor)
            .shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyAllSuccessTupleAsync(cfThis, { n }, { s }, { d }, { n }, Function { s })
            .shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyAllSuccessTupleAsync(cfThis, { n }, { s }, { d }, { n }, { s }, testExecutor)
            .shouldNotBeMinimalStage()

        CfTupleUtils.thenMApplyMostSuccessTupleAsync(cfThis, 1, MILLISECONDS, { n }, { s }).shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyMostSuccessTupleAsync(cfThis, 1, MILLISECONDS, { n }, { s }, testExecutor)
            .shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyMostSuccessTupleAsync(cfThis, 1, MILLISECONDS, { n }, { s }, Function { d })
            .shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyMostSuccessTupleAsync(cfThis, 1, MILLISECONDS, { n }, { s }, { d }, testExecutor)
            .shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyMostSuccessTupleAsync(cfThis, 1, MILLISECONDS, { n }, { s }, { d }, Function { n })
            .shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyMostSuccessTupleAsync(cfThis, 1, MILLISECONDS, { n }, { s }, { d }, { n }, testExecutor)
            .shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyMostSuccessTupleAsync(
            cfThis, 1, MILLISECONDS, { n }, { s }, { d }, { n }, Function { s }
        ).shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyMostSuccessTupleAsync(
            cfThis, 1, MILLISECONDS, { n }, { s }, { d }, { n }, { s }, testExecutor
        ).shouldNotBeMinimalStage()

        CfTupleUtils.thenMApplyTupleAsync(cfThis, { n }, { s }).shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyTupleAsync(cfThis, { n }, { s }, testExecutor).shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyTupleAsync(cfThis, { n }, { s }, Function { d }).shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyTupleAsync(cfThis, { n }, { s }, { d }, testExecutor).shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyTupleAsync(cfThis, { n }, { s }, { d }, Function { n }).shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyTupleAsync(cfThis, { n }, { s }, { d }, { n }, testExecutor).shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyTupleAsync(cfThis, { n }, { s }, { d }, { n }, Function { s }).shouldNotBeMinimalStage()
        CfTupleUtils.thenMApplyTupleAsync(cfThis, { n }, { s }, { d }, { n }, { s }, testExecutor)
            .shouldNotBeMinimalStage()
    ...
    fun test_CffuFactory_methods() {
        ...
        testCffuFac.tupleOps().mSupplyTupleFailFastAsync({ n }, { s }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleFailFastAsync({ n }, { s }, testFjExecutor).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleFailFastAsync({ n }, { s }, Supplier { d }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleFailFastAsync({ n }, { s }, { d }, testFjExecutor).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleFailFastAsync({ n }, { s }, { d }, Supplier { n }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleFailFastAsync({ n }, { s }, { d }, { n }, testFjExecutor)
            .shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleFailFastAsync({ n }, { s }, { d }, { n }, Supplier { s })
            .shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleFailFastAsync({ n }, { s }, { d }, { n }, { s }, testFjExecutor)
            .shouldNotBeMinimalStage()

        testCffuFac.tupleOps().mSupplyAllSuccessTupleAsync({ n }, { s }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyAllSuccessTupleAsync({ n }, { s }, testFjExecutor).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyAllSuccessTupleAsync({ n }, { s }, Supplier { d }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyAllSuccessTupleAsync({ n }, { s }, { d }, testFjExecutor)
            .shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyAllSuccessTupleAsync({ n }, { s }, { d }, Supplier { n })
            .shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyAllSuccessTupleAsync({ n }, { s }, { d }, { n }, testFjExecutor)
            .shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyAllSuccessTupleAsync({ n }, { s }, { d }, { n }, Supplier { s })
            .shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyAllSuccessTupleAsync({ n }, { s }, { d }, { n }, { s }, testFjExecutor)
            .shouldNotBeMinimalStage()

        testCffuFac.tupleOps().mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, testFjExecutor)
            .shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, Supplier { d })
            .shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d }, testFjExecutor)
            .shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d }, Supplier { n })
            .shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d }, { n }, testFjExecutor)
            .shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d }, { n }, Supplier { s })
            .shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyMostSuccessTupleAsync(
            1, MILLISECONDS, { n }, { s }, { d }, { n }, { s }, testFjExecutor
        ).shouldNotBeMinimalStage()

        testCffuFac.tupleOps().mSupplyTupleAsync({ n }, { s }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleAsync({ n }, { s }, testFjExecutor).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleAsync({ n }, { s }, Supplier { d }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleAsync({ n }, { s }, { d }, testFjExecutor).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleAsync({ n }, { s }, { d }, Supplier { n }).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleAsync({ n }, { s }, { d }, { n }, testFjExecutor).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mSupplyTupleAsync({ n }, { s }, { d }, { n }, Supplier { s }).shouldNotBeMinimalStage()
        ...
        testCffuFac.tupleOps().allTupleFailFastOf(cfN, cfS).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().allTupleFailFastOf(cfN, cfS, cfD).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().allTupleFailFastOf(cfN, cfS, cfD, cfN).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().allTupleFailFastOf(cfN, cfS, cfD, cfN, cfS).shouldNotBeMinimalStage()

        testCffuFac.tupleOps().allSuccessTupleOf(cfN, cfS).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().allSuccessTupleOf(cfN, cfS, cfD).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().allSuccessTupleOf(cfN, cfS, cfD, cfN).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().allSuccessTupleOf(cfN, cfS, cfD, cfN, cfS).shouldNotBeMinimalStage()

        testCffuFac.tupleOps().mostSuccessTupleOf(1, MILLISECONDS, cfN, cfS).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mostSuccessTupleOf(1, MILLISECONDS, cfN, cfS, cfD).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mostSuccessTupleOf(1, MILLISECONDS, cfN, cfS, cfD, cfN).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().mostSuccessTupleOf(1, MILLISECONDS, cfN, cfS, cfD, cfN, cfS).shouldNotBeMinimalStage()

        testCffuFac.tupleOps().allTupleOf(cfN, cfS).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().allTupleOf(cfN, cfS, cfD).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().allTupleOf(cfN, cfS, cfD, cfN).shouldNotBeMinimalStage()
        testCffuFac.tupleOps().allTupleOf(cfN, cfS, cfD, cfN, cfS).shouldNotBeMinimalStage()
    ...
    fun test_Cffu_methods() {
        ...
        cffuThis.tupleOps().thenMApplyTupleFailFastAsync({ n }, { s }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleFailFastAsync({ n }, { s }, testFjExecutor).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleFailFastAsync({ n }, { s }, Function { d }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleFailFastAsync({ n }, { s }, { d }, testFjExecutor).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleFailFastAsync({ n }, { s }, { d }, Function { n }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleFailFastAsync({ n }, { s }, { d }, { n }, testFjExecutor)
            .shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleFailFastAsync({ n }, { s }, { d }, { n }, Function { s })
            .shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleFailFastAsync({ n }, { s }, { d }, { n }, { s }, testFjExecutor)
            .shouldNotBeMinimalStage()

        cffuThis.tupleOps().thenMApplyAllSuccessTupleAsync({ n }, { s }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyAllSuccessTupleAsync({ n }, { s }, testFjExecutor).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyAllSuccessTupleAsync({ n }, { s }, Function { d }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyAllSuccessTupleAsync({ n }, { s }, { d }, testFjExecutor)
            .shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyAllSuccessTupleAsync({ n }, { s }, { d }, Function { n })
            .shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyAllSuccessTupleAsync({ n }, { s }, { d }, { n }, testFjExecutor)
            .shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyAllSuccessTupleAsync({ n }, { s }, { d }, { n }, Function { s })
            .shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyAllSuccessTupleAsync({ n }, { s }, { d }, { n }, { s }, testFjExecutor)
            .shouldNotBeMinimalStage()

        cffuThis.tupleOps().thenMApplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, testFjExecutor)
            .shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, Function { d })
            .shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d }, testFjExecutor)
            .shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d }, Function { n })
            .shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d }, { n }, testFjExecutor)
            .shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyMostSuccessTupleAsync(1, MILLISECONDS, { n }, { s }, { d }, { n }, Function { s })
            .shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyMostSuccessTupleAsync(
            1, MILLISECONDS, { n }, { s }, { d }, { n }, { s }, testFjExecutor
        )
            .shouldNotBeMinimalStage()

        cffuThis.tupleOps().thenMApplyTupleAsync({ n }, { s }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleAsync({ n }, { s }, testFjExecutor).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleAsync({ n }, { s }, Function { d }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleAsync({ n }, { s }, { d }, testFjExecutor).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleAsync({ n }, { s }, { d }, Function { n }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleAsync({ n }, { s }, { d }, { n }, testFjExecutor).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleAsync({ n }, { s }, { d }, { n }, Function { s }).shouldNotBeMinimalStage()
        cffuThis.tupleOps().thenMApplyTupleAsync({ n }, { s }, { d }, { n }, { s }, testFjExecutor)
            .shouldNotBeMinimalStage()

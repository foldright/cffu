...
/**
 * DO NOT use this type in your application, use {@link Cffu} / {@link MCffu} instead.
 *
...
public abstract class BaseCffu<T, F extends BaseCffu<T, F>> implements Future<T>, CompletionStage<T> {
    ...
    final boolean isMinimalStage;

    final CffuFactory fac;

    BaseCffu(CffuFactory cffuFactory, boolean isMinimalStage, CompletableFuture<T> cf) {
    ...
    abstract F reset0(CffuFactory fac, boolean isMinimalStage, CompletableFuture<T> cf);

    F reset0(CompletableFuture<T> cf) {
        return reset0(fac, isMinimalStage, cf);
    }
    ...
    @Contract(pure = true)
    <U> Cffu<U> resetToCffu0(CompletableFuture<U> cf) {
        return new Cffu<>(fac, isMinimalStage, cf);
    }

    <E, U extends Iterable<? extends E>> MCffu<E, U> resetToMCffu0(CompletableFuture<U> cf) {
    ...
    public <U> Cffu<U> thenApply(Function<? super T, ? extends U> fn) {
        return resetToCffu0(cf.thenApply(fn));
    }
    ...
    public <U> Cffu<U> thenApplyAsync(Function<? super T, ? extends U> fn, Executor executor) {
        return resetToCffu0(cf.thenApplyAsync(fn, cffuScreened(executor)));
    }
    ...
    public Cffu<Void> thenAccept(Consumer<? super T> action) {
        return resetToCffu0(cf.thenAccept(action));
    }
    ...
    public Cffu<Void> thenAcceptAsync(Consumer<? super T> action, Executor executor) {
        return resetToCffu0(cf.thenAcceptAsync(action, cffuScreened(executor)));
    }
    ...
    public Cffu<Void> thenRun(Runnable action) {
        return resetToCffu0(cf.thenRun(action));
    }
    ...
    public Cffu<Void> thenRunAsync(Runnable action, Executor executor) {
        return resetToCffu0(cf.thenRunAsync(action, cffuScreened(executor)));
    }
    ...
    //
    //    - thenMApply* (Function[]: T -> U)       -> MCffu<U, List<U>>
    ...
    public final <U> MCffu<U, List<U>> thenMApplyFailFastAsync(Executor executor, Function<? super T, ? extends U>... fns) {
        return resetToMCffu0(CompletableFutureUtils.thenMApplyFailFastAsync(cf, cffuScreened(executor), fns));
    }
    ...
    public <U, V> Cffu<V> thenCombine(
        ...
        return resetToCffu0(cf.thenCombine(other, fn));
    }
    ...
    public <U, V> Cffu<V> thenCombineAsync(
        ...
        return resetToCffu0(cf.thenCombineAsync(other, fn, cffuScreened(executor)));
    }
    ...
    public <U> Cffu<Void> thenAcceptBoth(CompletionStage<? extends U> other, BiConsumer<? super T, ? super U> action) {
        return resetToCffu0(cf.thenAcceptBoth(other, action));
    }
    ...
    public <U> Cffu<Void> thenAcceptBothAsync(
        ...
        return resetToCffu0(cf.thenAcceptBothAsync(other, action, cffuScreened(executor)));
    }
    ...
    public Cffu<Void> runAfterBoth(CompletionStage<?> other, Runnable action) {
        return resetToCffu0(cf.runAfterBoth(other, action));
    }
    ...
    public Cffu<Void> runAfterBothAsync(CompletionStage<?> other, Runnable action, Executor executor) {
        return resetToCffu0(cf.runAfterBothAsync(other, action, cffuScreened(executor)));
    }
    ...
    public <U> Cffu<U> applyToEither(CompletionStage<? extends T> other, Function<? super T, U> fn) {
        return resetToCffu0(cf.applyToEither(other, fn));
    }
    ...
    public <U> Cffu<U> applyToEitherAsync(
        ...
        return resetToCffu0(cf.applyToEitherAsync(other, fn, cffuScreened(executor)));
    }
    ...
    public Cffu<Void> acceptEither(CompletionStage<? extends T> other, Consumer<? super T> action) {
        return resetToCffu0(cf.acceptEither(other, action));
    }
    ...
    public Cffu<Void> acceptEitherAsync(
        ...
        return resetToCffu0(cf.acceptEitherAsync(other, action, cffuScreened(executor)));
    }
    ...
    public Cffu<Void> runAfterEither(CompletionStage<?> other, Runnable action) {
        return resetToCffu0(cf.runAfterEither(other, action));
    }
    ...
    public Cffu<Void> runAfterEitherAsync(CompletionStage<?> other, Runnable action, Executor executor) {
        return resetToCffu0(cf.runAfterEitherAsync(other, action, cffuScreened(executor)));
    }
     ...
     */
    public <X extends Throwable> F catching(Class<X> exceptionType, Function<? super X, ? extends T> fallback) {
        return reset0(CompletableFutureUtils.catching(cf, exceptionType, nonExSwallowedFunction(fallback, false)));
    }
     ...
     * @see Futures#catching the equivalent Guava method catching()
     */
    public <X extends Throwable> F catchingAsync(
    ...
    public <X extends Throwable> F catchingAsync(
        ...
        return reset0(CompletableFutureUtils.catchingAsync(
     ...
     */
    @Override
    public F exceptionally(Function<Throwable, ? extends T> fn) {
        return reset0(cf.exceptionally(nonExSwallowedFunction(fn, false)));
    }
     ...
     */
    @Override
    public F exceptionallyAsync(Function<Throwable, ? extends T> fn) {
     ...
     */
    @Override
    public F exceptionallyAsync(Function<Throwable, ? extends T> fn, Executor executor) {
        return reset0(CompletableFutureUtils.exceptionallyAsync(cf, nonExSwallowedFunction(fn, false), cffuScreened(executor)));
    }
     ...
     * orTimeout
     */
    public F orTimeout(long timeout, TimeUnit unit) {
        checkMinimalStage();
        return reset0(CompletableFutureUtils.cffuOrTimeout(cf, timeout, unit, fac.defaultExecutor));
    }
    ...
    public <U> Cffu<U> thenCompose(Function<? super T, ? extends CompletionStage<U>> fn) {
        return resetToCffu0(cf.thenCompose(fn));
    }
    ...
    public <U> Cffu<U> thenComposeAsync(Function<? super T, ? extends CompletionStage<U>> fn, Executor executor) {
        return resetToCffu0(cf.thenComposeAsync(fn, cffuScreened(executor)));
    }

    @Override
    public F exceptionallyCompose(Function<Throwable, ? extends CompletionStage<T>> fn) {
        return reset0(CompletableFutureUtils.exceptionallyCompose(cf, nonExSwallowedFunction(fn, false)));
    }

    @Override
    public F exceptionallyComposeAsync(Function<Throwable, ? extends CompletionStage<T>> fn) {
        return exceptionallyComposeAsync(fn, cffuFactory().defaultExecutor);
    }

    @Override
    public F exceptionallyComposeAsync(Function<Throwable, ? extends CompletionStage<T>> fn, Executor executor) {
        return reset0(CompletableFutureUtils.exceptionallyComposeAsync(cf, nonExSwallowedFunction(fn, false), cffuScreened(executor)));
    }
    ...
    public <U> Cffu<U> handle(BiFunction<? super T, Throwable, ? extends U> fn) {
        return resetToCffu0(cf.handle(nonExSwallowedBiFunction(fn, false)));
    }
    ...
    public <U> Cffu<U> handleAsync(BiFunction<? super T, Throwable, ? extends U> fn, Executor executor) {
        return resetToCffu0(cf.handleAsync(nonExSwallowedBiFunction(fn, false), cffuScreened(executor)));
    }
    ...
    @CheckReturnValue(explanation = "should use the returned Cffu; otherwise, prefer method `peek`")
    @Override
    public F whenComplete(BiConsumer<? super T, ? super Throwable> action) {
        return reset0(cf.whenComplete(nonExSwallowedWrapForJava8(action)));
    }
    ...
    @CheckReturnValue(explanation = "should use the returned Cffu; otherwise, prefer method `peekAsync`")
    @Override
    public F whenCompleteAsync(BiConsumer<? super T, ? super Throwable> action) {
    ...
    @CheckReturnValue(explanation = "should use the returned Cffu; otherwise, prefer method `peekAsync`")
    @Override
    public F whenCompleteAsync(BiConsumer<? super T, ? super Throwable> action, Executor executor) {
        return reset0(cf.whenCompleteAsync(nonExSwallowedWrapForJava8(action), cffuScreened(executor)));
    }
    // endregion
    ////////////////////////////////////////////////////////////////////////////////
     ...
     */
    @Contract("_ -> this")
    public F completeAsync(Supplier<? extends T> supplier) {
     ...
     */
    @Contract("_, _ -> this")
    public F completeAsync(Supplier<? extends T> supplier, Executor executor) {
        checkMinimalStage();
    ...
    public CompletionStage<T> minimalCompletionStage() {
        return reset0(fac, true, (CompletableFuture<T>) CompletableFutureUtils.minimalCompletionStage(cf));
    }
     ...
     */
    @Contract(pure = true)
    public F withDefaultExecutor(Executor defaultExecutor) {
     ...
     */
    @Contract(pure = true)
    public F withCffuFactory(CffuFactory cffuFactory) {
        ...
        return reset0(cffuFactory, isMinimalStage, CompletableFutureUtils.copy(cf));
    }
    ...
    @Contract(pure = true)
    public F copy() {
        return reset0(fac, isMinimalStage, CompletableFutureUtils.copy(cf));
    }
    ...
    public Executor defaultExecutor() {
        return cffuFactory().defaultExecutor();
    }
    ...
    public boolean forbidObtrudeMethods() {
        return cffuFactory().forbidObtrudeMethods();
    }
    ...
    public <U> Cffu<U> newIncompleteFuture() {
        return cffuFactory().newIncompleteCffu();
    }
    ...
    public final class TupleOps {
        ...
        public <U1, U2, U3, U4, U5> Cffu<Tuple5<U1, U2, U3, U4, U5>> thenMApplyTupleFailFastAsync(
            ...
            return thenMApplyTupleFailFastAsync(fn1, fn2, fn3, fn4, fn5, cffuFactory().defaultExecutor);
        }
        ...
        public <U1, U2, U3, U4, U5> Cffu<Tuple5<U1, U2, U3, U4, U5>> thenMApplyTupleFailFastAsync(
            ...
            return resetToCffu0(CfTupleUtils.thenMApplyTupleFailFastAsync(cf, fn1, fn2, fn3, fn4, fn5, cffuScreened(executor)));
        }

...
public final class CompletableFutureUtils {
    ...
    public static <T, U, V> CompletableFuture<V> thenCombineFastFailAsync(
        ...
        return bothFastFail0(cfThis, other).thenApplyAsync(t -> fn.apply(t._1, t._2));
    }
    ...
    public static <T, U> CompletableFuture<Void> thenAcceptBothFastFailAsync(
        ...
        return bothFastFail0(cfThis, other).thenAcceptAsync(t -> action.accept(t._1, t._2));
    }
    ...
    public static <T> CompletableFuture<Void> acceptEitherSuccessAsync(
        ...
        return eitherSuccess0(cfThis, other).thenAcceptAsync(action);
    }

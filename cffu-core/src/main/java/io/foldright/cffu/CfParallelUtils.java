...
public final class CfParallelUtils {
    ...
    public static <T, U> CompletableFuture<List<U>> thenParApplyFailFastAsync(
        ...
        return f_toCf0(cfThis.thenCompose(elements -> parApplyFailFastAsync(elements, fn, executor)));
    }
    ...
    public static <T, U> CompletableFuture<List<U>> thenParApplyAllSuccessAsync(
        ...
        return f_toCf0(cfThis.thenCompose(elements -> parApplyAllSuccessAsync(elements, valueIfFailed, fn, executor)));
    }
    ...
    public static <T, U> CompletableFuture<List<U>> thenParApplyMostSuccessAsync(
        ...
        return f_toCf0(cfThis.thenCompose(elements -> parApplyMostSuccessAsync(elements, valueIfNotSuccess, timeout, unit, fn, executor)));
    }
    ...
    public static <T, U> CompletableFuture<List<U>> thenParApplyAsync(
        ...
        return f_toCf0(cfThis.thenCompose(elements -> parApplyAsync(elements, fn, executor)));
    }
    ...
    public static <T, U> CompletableFuture<U> thenParApplyAnySuccessAsync(
        ...
        return f_toCf0(cfThis.thenCompose(elements -> parApplyAnySuccessAsync(elements, fn, executor)));
    }
    ...
    public static <T, U> CompletableFuture<U> thenParApplyAnyAsync(
        ...
        return f_toCf0(cfThis.thenCompose(elements -> parApplyAnyAsync(elements, fn, executor)));
    }
    ...
    public static <T> CompletableFuture<Void> thenParAcceptFailFastAsync(
        ...
        return f_toCf0(cfThis.thenCompose(elements -> parAcceptFailFastAsync(elements, action, executor)));
    }
    ...
    public static <T> CompletableFuture<Void> thenParAcceptAsync(
        ...
        return f_toCf0(cfThis.thenCompose(elements -> parAcceptAsync(elements, action, executor)));
    }
    ...
    public static <T> CompletableFuture<Void> thenParAcceptAnySuccessAsync(
        ...
        return f_toCf0(cfThis.thenCompose(elements -> parAcceptAnySuccessAsync(elements, action, executor)));
    }
    ...
    public static <T> CompletableFuture<Void> thenParAcceptAnyAsync(
        ...
        return f_toCf0(cfThis.thenCompose(elements -> parAcceptAnyAsync(elements, action, executor)));
    }

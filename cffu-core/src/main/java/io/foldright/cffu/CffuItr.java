...
/**
 * Cffu with result type {@link Iterable}, {@code CffuItr<T, List<T>>} is same as {@code CffuItr<List<T>>} except with more methods.
 */
public class CffuItr<T, C extends Iterable<T>> extends Cffu<C> {
    ////////////////////////////////////////////////////////////////////////////////
    ...
    @Contract(pure = true)
    CffuItr(CffuFactory cffuFactory, boolean isMinimalStage, CompletableFuture<C> cf) {
    ...
    public final class ParOps {
        ...
        //
        //    - thenParApply* (CF<Iterable>, Function: T -> U)    -> CffuItr<U, List<U>>
        ...
        public <U> CffuItr<U, List<U>> thenParApplyFailFastAsync(Function<? super T, ? extends U> fn) {
         ...
         */
        @CheckReturnValue(explanation = "should use the returned Cffu; otherwise, prefer simple method `thenParAcceptAsync`")
        public <U> CffuItr<U, List<U>> thenParApplyFailFastAsync(Function<? super T, ? extends U> fn, Executor executor) {
         ...
         */
        @CheckReturnValue(explanation = "should use the returned Cffu; otherwise, prefer simple method `thenParAcceptAsync`")
        public <U> CffuItr<U, List<U>> thenParApplyAllSuccessAsync(@Nullable U valueIfFailed, Function<? super T, ? extends U> fn) {
         ...
         */
        @CheckReturnValue(explanation = "should use the returned Cffu; otherwise, prefer simple method `thenParAcceptAsync`")
        public <U> CffuItr<U, List<U>> thenParApplyAllSuccessAsync(@Nullable U valueIfFailed, Function<? super T, ? extends U> fn, Executor executor) {
         ...
         */
        @CheckReturnValue(explanation = "should use the returned Cffu; otherwise, prefer simple method `thenParAcceptAsync`")
        public <U> CffuItr<U, List<U>> thenParApplyMostSuccessAsync(
         ...
         */
        @CheckReturnValue(explanation = "should use the returned Cffu; otherwise, prefer simple method `thenParAcceptAsync`")
        public <U> CffuItr<U, List<U>> thenParApplyAsync(Function<? super T, ? extends U> fn) {
         ...
         */
        @CheckReturnValue(explanation = "should use the returned Cffu; otherwise, prefer simple method `thenParAcceptAsync`")
        public <U> CffuItr<U, List<U>> thenParApplyAsync(Function<? super T, ? extends U> fn, Executor executor) {
